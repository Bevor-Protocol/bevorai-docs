...
Findings can be produced in 3 ways: Bevor's Security Pipeline, your own security workflow or external tools, Bevor's chat interface. For a more detailed breakdown on findings, see [here](./findings)
