---
title: 'Glossary'
description: 'Key terms and concepts in Bevor and blockchain security'
---

# Glossary

Comprehensive definitions of key terms and concepts used throughout Bevor documentation and the broader blockchain security ecosystem.

## Bevor-Specific Terms

### Bevor
AI-native security infrastructure that connects code, analyses, findings, remediations, and contributors through a persistent project graph.

### Security Agent
Specialized AI agents within the Bevor ecosystem that focus on specific security domains (e.g., reentrancy detection, economic analysis, governance security). Agents can work independently or in coordination with other agents.
...
### Bevor Skill
A planned Agent Skill that helps Claude, Codex, and compatible coding agents use the Bevor CLI and SDK through a bounded, graph-aware workflow.

### Security Data Labeling
The process of expert security auditors reviewing and tagging Bevor's findings to improve the accuracy and effectiveness of the AI models. Contributors earn rewards for high-quality labeling.

### BEVOR Token
The native utility token of the Bevor ecosystem, used for governance, accessing premium features, rewarding contributors, and incentivizing security improvements across the network.
...
A typed client library for accessing Bevor resources without managing raw HTTP requests.
...
<CardGroup cols={2}>
  <Card title="Join Telegram" icon="message" href="https://t.me/CertaiKVirtuals">
    Get help and suggest terms in our Telegram community
  </Card>
  <Card title="Contact Us" icon="envelope" href="mailto:contact@bevor.io">
    Email us to suggest new glossary entries
  </Card>
</CardGroup>

---

*This glossary is maintained by the Bevor community. Definitions are regularly updated to reflect current best practices and emerging concepts in blockchain security.*
