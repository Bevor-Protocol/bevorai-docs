...
export function TOC({ container, header, footer, style = 'normal', list }: TOCProps) {
  ...
  return (
    <div
      ...
      {...container}
      className={cn(
        'sticky top-(--fd-docs-row-2) h-[calc(var(--fd-docs-height)-var(--fd-docs-row-2))] flex flex-col [grid-area:toc] w-(--fd-toc-width) pt-14 pe-4 pb-2 xl:layout:[--fd-toc-width:268px] max-xl:hidden',
        container?.className,
      )}
    >
      {header}
