...
<CardGroup cols={2}>
  <Card title="Start Labeling" icon="tag" href="/auditors/data-labeling">
    Begin contributing to Bevor's security dataset
  </Card>
  <Card title="Follow Bevor" icon="x-twitter" href="https://x.com/bevor_io">
    Follow product and community updates on X
  </Card>
</CardGroup>
